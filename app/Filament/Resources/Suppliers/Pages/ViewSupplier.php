...
class ViewSupplier extends ViewRecord
{
    ...
    /**
     * Lists the products right below the supplier, before notes and history.
     */
        ...
        return $schema
            ->components([
                ...
                View::make('filament.partials.notes-and-documents')
                    ->viewData(['notesDescription' => 'Erfahrungen mit dem Lieferanten — z. B. „Nächstes Mal früher anfragen, war im November knapp“.']),
