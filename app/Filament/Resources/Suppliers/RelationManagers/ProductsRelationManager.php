...
/**
 * The products of a supplier, with the table, form and permissions of
...
class ProductsRelationManager extends RelationManager
{
    ...
    /**
     * The supplier's view page is where its products are maintained,
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->mutateDataUsing(fn (array $data): array => [
                        ...ProductForm::prepareForSave([...$data, 'supplier_id' => $this->getOwnerRecord()->getKey()]),
                        'created_by_user_id' => auth()->id(),
                    ]),
            ])
            ->emptyStateDescription('Lege das erste Produkt dieses Lieferanten mit seinen Gebindegrößen an.');
    }
}
